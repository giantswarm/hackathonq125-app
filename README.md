[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/hackathondummy/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/hackathondummy/tree/main)

[Read me after cloning this template (GS staff only)](https://handbook.giantswarm.io/docs/dev-and-releng/app-developer-processes/adding_app_to_appcatalog/)

# hackathondummy chart

Giant Swarm offers a hackathondummy App which can be installed in workload clusters.
Here, we define the hackathondummy chart with its templates and default configuration.
